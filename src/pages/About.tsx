...
export default function About() {
    ...
    return (
        <section 
            id="about" 
            ref={containerRef}
            className="relative w-full min-h-[150vh] bg-bg overflow-hidden py-40 px-6 md:px-12 flex flex-col items-center"
        >
            <motion.h2 
                style={{ x: xLeft }}
            ...
            <div className="relative z-10 max-w-7xl w-full flex flex-col gap-40">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    ...
                    >
                        ...
                        <div className="relative p-12 bg-accent/5 backdrop-blur-xl rounded-2xl">
                            <h3 className="text-gold font-title text-5xl italic mb-10">Nossa Herança</h3>
                            <p className="text-secondary font-text text-2xl md:text-3xl leading-relaxed opacity-90">
                    ...
                    >
                        <h3 className="text-gold font-title text-5xl italic">A Curadoria</h3>
                        <p className="text-secondary/80 font-text text-xl md:text-2xl leading-relaxed border-l-2 border-gold/30 pl-8">
                        ...
                        <div className="grid grid-cols-2 gap-8 pt-8">
                            <div>
                                <h4 className="text-gold font-title text-7xl italic">12</h4>
                                <p className="text-secondary/50 font-text text-lg uppercase tracking-widest">Maisons</p>
                            </div>
                            <div>
                                <h4 className="text-gold font-title text-7xl italic">Pure</h4>
                                <p className="text-secondary/50 font-text text-lg uppercase tracking-widest">Essência</p>
                            </div>
                        </div>
                    </motion.div>
                </div>
                ...
                >
                    <motion.div 
                        ...
                        className="w-[300px] h-[300px] bg-gold/10 blur-[100px] absolute rounded-full"
                    ></motion.div>
                    
                    <h3 className="relative z-10 text-primary font-title text-5xl md:text-7xl italic text-center mb-12">
                        Pronto para deixar sua <br /> <span className="text-gold">Assinatura?</span>
                    </h3>
                    
                    <button className="relative z-10 px-16 py-6 border-2 border-gold text-gold font-text text-xl uppercase tracking-[0.3em] hover:bg-gold hover:text-bg transition-all duration-500 rounded-full group overflow-hidden">
